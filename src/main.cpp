        ...
        if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
            ...
            if (s != "") {
                ...
                if (event == "telemetry") {
                    ...
                    // Step. Convert ptsx, ptsy from global map to car coordinate space.
                    ...
                    // Step . Display the waypoints/reference line
                    ...
                    // Step. Display the MPC predicted trajectory
